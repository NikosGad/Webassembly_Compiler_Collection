...
def perform_compilation(language):
    ...
    return compilation_handler.compile(source_code_file, compilation_options_json)
...
def perform_compilation_and_store(language):
    ...
    return compilation_handler.compile(source_code_file, compilation_options_json, store=True)
